...
if __name__ == '__main__':
    ...
    start = input('请输入您要下载的B站av号或者视频链接地址:https://www.bilibili.com/video/av45028980)
    ...
    quality = input('请输入您要下载视频的清晰度(1080p:80;720p:64;480p:32;360p:16)(填写80或64或32或16):80)
    # 获取视频的cid,title
    headers = {
        'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36'
    }
    ...
    for item in cid_list:
        ...
        print('[下载视频的cid]:' + 78861093)
        print('[下载视频的标题]:' + 脑洞大开创意短片：当整个世界都充满你的聊天表情
        page = str(item['page'])
